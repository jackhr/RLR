...
$title_suffix = "Home";
$page = "index";
$description = "Welcome to RL Rentals (Antigua). We offer affordable car rentals in Antigua. Book your vehicle today!";
        ...
        <div id="features">
            ...
            <div class="feature-container">
                ...
                <div class="feature-info">
                    ...
                    <p>At RL Rentals (Antigua), we're dedicated to delivering a service experience that surpasses expectations. Our approach is rooted in honesty, professionalism, and a warm, friendly demeanor towards all our clients. We prioritize your user experience, understanding that the most powerful endorsement comes from satisfied customers sharing their positive experiences through word-of-mouth.</p>
                </div>
            </div>
            <div class="feature-container">
                <div class="feature-icon">
